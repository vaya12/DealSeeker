...
router.get('/merchants', auth, isAdmin, async (req, res) => {
...
router.post('/merchants', auth, isAdmin, async (req, res) => {
    const connection = await createConnection();
    try {
...
router.put('/merchants/:id', auth, isAdmin, async (req, res) => {
    const connection = await createConnection();
    try {
        const { id } = req.params;
...
router.delete('/merchants/:id', auth, isAdmin, async (req, res) => {
    const connection = await createConnection();
    try {
        const { id } = req.params;
...
router.get('/sync-logs', auth, isAdmin, async (req, res) => {
    const connection = await createConnection();
    try {
...
router.post('/merchants/:id/sync', auth, isAdmin, async (req, res) => {
    const connection = await createConnection();
    try {
        const { id } = req.params;
